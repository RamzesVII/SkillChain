      ...
      <div className="flip-inner" style={{ height: "100%", minHeight: 236 }}>
        ...
        <div className="flip-face flip-front">
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <span className="grad-text" style={{ fontFamily: "var(--font-fraunces)", fontStyle: "italic", fontWeight: 500, fontSize: 27, lineHeight: 1, padding: "2px 6px 2px 4px", display: "inline-block" }}>
              {idxStr}
            </span>
